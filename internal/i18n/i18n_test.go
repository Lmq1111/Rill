...
// $LC_ALL / $RILLAGENT_LANG. Unknown locales return "" so DetectLanguage falls
...
// TestDetectLanguagePriority verifies override beats env and that RILLAGENT_LANG
...
func TestDetectLanguagePriority(t *testing.T) {
	...
	t.Setenv("RILLAGENT_LANG", "en")
	if got := DetectLanguage(""); got != "en" {
		t.Errorf("RILLAGENT_LANG=en overriding LANG=zh: got %q, want en", got)
	}
