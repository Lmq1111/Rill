...
type Set struct {
	Docs    []Source // RILL.md / AGENTS.md, ascending precedence
...
// (RILL.md / AGENTS.md / CLAUDE.md, in that order); when none exists it
// creates the Rill default (RILL.md / RILL.local.md). ScopeUser →
