...
const (
	...
	refImage                   // a local image attachment: @.rillagent/attachments/<file>
)
...
const externalFolderRefPrefix = "__rillagent_external_folder"
...
func isAttachmentRef(token string) bool {
	return strings.HasPrefix(filepath.ToSlash(token), ".rillagent/attachments/")
}
...
// text rather than a Rill slash command.
