...
func TestManagedConfigWriteApprovalIsFreshHuman(t *testing.T) {
	...
	subject := "write Rill config: /home/u/.rillagent/config.toml"
	...
	if !a.preApprovedForDecision(ManagedConfigWriteApprovalTool, "write Rill config: /other/path", nil, true) {
