...
const DM = "__RILLAGENT_MATH_DISPLAY__";
const IM = "__RILLAGENT_MATH_INLINE__";
const LB = "__RILLAGENT_LATEX_LINEBREAK__";
const ED_BASE = "RILLAGENTESCAPEDDOLLAR";
const DOLLAR = "&#36;";
...
function unusedPlaceholderPrefix(s: string): string {
  let prefix = "__RILLAGENT_PROTECTED_CODE__";
  let n = 0;
  while (s.includes(prefix)) {
    n += 1;
    prefix = `__RILLAGENT_PROTECTED_CODE_${n}__`;
  }
  return prefix;
}
