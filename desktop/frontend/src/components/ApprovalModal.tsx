...
const configWriteEnglishSubjectPrefix = "write Rill config: ";
...
function localizeApprovalReason(tool: string, reason: string | undefined, t: Translator): string {
  ...
  if (tool === "config_write") {
    if (!trimmed || trimmed.includes("Rill-managed configuration file")) return t("approval.configWriteReason");
    return trimmed;
  }
