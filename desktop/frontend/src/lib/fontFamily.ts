...
const FONT_FAMILY_KEY = "rillagent-font-family";
const CUSTOM_FONT_KEY = "rillagent-font-family-custom";
const MONO_FONT_FAMILY_KEY = "rillagent-mono-font-family";
const CUSTOM_MONO_FONT_KEY = "rillagent-mono-font-family-custom";
