...
const STORAGE_KEY = "rillagent.layoutPreferences.v1";

const LEGACY_SIZE_KEYS: Record<LayoutSizeKey, string[]> = {
  sidebarWidth: ["rillagent.sidebar.width"],
  sidebarWidthGraphite: [],
  rightDockWidth: [],
  rightDockTreeWidth: [],
  rightDockPreviewWidth: [],
  workspaceFileTreePanelWidth: [],
  workspaceTreeWidth: ["rillagent.workspaceTree.width"],
  composerHeight: ["rillagent.composerHeight"],
  drawerWidth: ["rillagent.drawer.width"],
  settingsDrawerWidth: ["rillagent.settingsDrawer.width"],
};
