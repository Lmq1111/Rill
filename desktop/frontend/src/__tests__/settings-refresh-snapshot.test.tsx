  ...
  return {
    ...
    bot: {
      ...
      model: "",
	      ...
	      control: { enabled: false, addr: "127.0.0.1:37913", tokenEnv: "RILLAGENT_BOT_CONTROL_TOKEN" },
    ...
    configPath: "/tmp/rillagent/config.toml",
    providerKinds: [],
  ...
  main: {
    App: {
      Settings: async () => {
        ...
        if (failingSettingsCalls === 1) throw new Error("/Users/example/.rillagent/settings.toml: permission denied");
...
localStorage.setItem("rillagent-zoom-restart", "1");
await act(async () => {
  zoomRoot.render(
    <LocaleProvider>
      <SettingsPanel
...
eq(localStorage.getItem("rillagent-zoom-restart"), "1", "display zoom reset updates the local restart zoom cache");
