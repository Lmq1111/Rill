...
const named = parseAttachmentRefsForDisplay(
  "review @[DS30000.sl2](.rillagent/attachments/clipboard-20260610-121238.444775-000002.sl2) and @[park.png](.rillagent/attachments/clipboard-20260610-121238.444775-000001.png)",
);
...
eq(
  ...
  [
    {
      path: ".rillagent/attachments/clipboard-20260610-121238.444775-000002.sl2",
      name: "DS30000.sl2",
      kind: "file",
      ext: "SL2",
    },
    {
      path: ".rillagent/attachments/clipboard-20260610-121238.444775-000001.png",
      name: "park.png",
      kind: "image",
      ext: "PNG",
    },
...
eq(
  replaceAttachmentRefsForDisplay("see @[DS30000.sl2](.rillagent/attachments/clipboard-20260610-121238.444775-000002.sl2)"),
  "see [file:DS30000.sl2]",
  "compact previews use named display refs",
);
eq(
  restoreAttachmentRefsForSubmit("review @[DS30000.sl2](.rillagent/attachments/clipboard-20260610-121238.444775-000002.sl2), then @[park.png](.rillagent/attachments/clipboard-20260610-121238.444775-000001.png)"),
  "review @.rillagent/attachments/clipboard-20260610-121238.444775-000002.sl2, then @.rillagent/attachments/clipboard-20260610-121238.444775-000001.png",
  "restores named display refs for submit",
);
eq(
  formatAttachmentRefForDisplay({ path: ".rillagent/attachments/clipboard-20260610-121238.444775-000001.png", name: "park.png", source: "attachment" }),
  "@[park.png](.rillagent/attachments/clipboard-20260610-121238.444775-000001.png)",
  "formats attachment display refs for edit replay",
);
eq(
  formatAttachmentRefForSubmit({ path: ".rillagent/attachments/clipboard-20260610-121238.444775-000001.png" }),
  "@.rillagent/attachments/clipboard-20260610-121238.444775-000001.png",
