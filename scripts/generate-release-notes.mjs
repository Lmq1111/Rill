...
async function githubJson(path, { allowMissing = false } = {}) {
  const headers = { Accept: "application/vnd.github+json", "User-Agent": "rillagent-release-notes" };
...
async function main() {
  ...
  release.links = {
    ...
    download: "https://github.com/Lmq1111/Rill/releases",
  };
